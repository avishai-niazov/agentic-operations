...
1. Create a new empty GitHub repository named `planerium-agentic-operations`
...
git branch -M main
git add .
git commit -m "Initial scaffold for Planerium Agentic Operations Framework"
git remote add origin git@github.com:avishai-niazov/planerium-agentic-operations.git
